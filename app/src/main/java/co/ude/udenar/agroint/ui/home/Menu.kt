...
import co.ude.udenar.agroint.data.RetrofitService
import co.ude.udenar.agroint.data.model.WeekForcast
import com.google.android.gms.location.FusedLocationProviderClient
import com.google.android.gms.location.LocationServices
import kotlinx.coroutines.delay

class Menu(requireContext: Context) : AppCompatActivity() {
    ...
    suspend fun obtenerInformacion(context: Context): String {
        // Simulación de trabajo
        delay(1000)

        // Devolver algún resultado
        return "Información desde la clase Menu"
    }
